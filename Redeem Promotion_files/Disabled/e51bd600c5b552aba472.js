  ...
  [25],
  {
    1364: function (t, e, o) {
      ...
      function O(t, e, o, r) {
        ...
        if ((e || 0 === a || (e = { children: void 0 }), 1 === a))
          e.children = r;
        else if (a > 1) {
          for (var s = new Array(a), l = 0; l < a; l++) s[l] = arguments[l + 3];
          e.children = s;
        }
        if (e && i) for (var p in i) void 0 === e[p] && (e[p] = i[p]);
        else e || (e = i || {});
        return {
          $$typeof: n,
          type: t,
      ...
      var R = (function () {
          function t() {
            this.animated = new s.default.ValueXY({ x: 0, y: 0 });
          }
          var e = t.prototype;
          return (
            (e.run = function (t, e, o) {
              var n = e.position;
              this.animated.setValue(D(n)), o();
            }),
            (e.getStyle = function () {
        ...
        W = (function () {
          ...
          var e = t.prototype;
          return (
            (e.computeStyles = function (t) {
              var e, o;
              switch (t) {
                case "left":
                  (e = { x: -1.05, y: 0 }), (o = { x: -1, y: 0 });
                  break;
                case "right":
                  (e = { x: 0.05, y: 0 }), (o = { x: 0, y: 0 });
                  break;
                case "bottom":
                  (e = { x: -0.5, y: 0.05 }), (o = { x: -0.5, y: 0 });
                  break;
                case "bottom-left":
                  (e = { x: 0, y: 0.05 }), (o = { x: 0, y: 0 });
                  break;
                case "bottom-right":
                  (e = { x: 0, y: 0.05 }), (o = { x: -1, y: 0 });
                  break;
                case "top-left":
                  (e = { x: 0, y: -1.05 }), (o = { x: 0, y: -1 });
                  break;
                case "top-right":
                  (e = { x: 0, y: -1.05 }), (o = { x: -1, y: -1 });
                  break;
                case "top":
                default:
                  (e = { x: -0.5, y: -1.05 }), (o = { x: -0.5, y: -1 });
              }
              return { startStyle: e, endStyle: o };
            }),
            (e.run = function (t, e, o) {
              var n = e.position,
        ...
        M = (function (t) {
          function e(e) {
            var o, n;
            switch (
              (((o = t.call(this, e) || this).preventNextClose = !1),
              (o.componentWillEnterCallback = function () {}),
              (o.close = function (t) {
                if (o.preventNextClose && u.default.isOpen())
                  o.preventNextClose = !1;
                else {
                  var e = o.props,
                    n = e.popoutKey,
                  ...
                  if (!r || !c.default.hasModalOpen()) {
                    if (null != t) {
                      for (
                        var l = t.target, p = a.default.findDOMNode(k(o));
                        ...
                        if (
                          null != l.classList &&
                          (l.classList.contains("popout-open") ||
                            l.classList.contains(b.default.layer))
                        )
                          return;
                        l = l.parentNode;
                      }
              ...
              (o.closeContext = function (t) {
                if (null != t)
                  for (
                    var e = t.target, n = a.default.findDOMNode(k(o));
                    null != e;
                ...
                o.preventNextClose && u.default.isOpen()
                  ? (o.preventNextClose = !1)
                  : f.default.close(o.props.popoutKey);
              }),
              (o.updateOffsets = function () {
                ...
                n ||
                  ((p =
                    "top" === e || "top-right" === e || "top-left" === e
                      ? o.props.y < 0.5 * window.innerHeight &&
                        o.props.y - i.offsetHeight < 0
                      : o.props.y + o.props.targetHeight + 14 + l >=
                        window.innerHeight) &&
                    ("bottom" === e
                      ? (e = "top")
                      : "bottom-left" === e
                ...
                switch (e) {
                  ...
                  case "right":
                    ...
                    break;
                  case "bottom":
                    (f.offsetX = o.props.targetWidth / 2),
                      (f.offsetY = o.props.targetHeight);
                    break;
                  case "bottom-left":
                ...
                !p ||
                  ...
                  (o.props.closeOnScroll
                    ? (f.offsetY -= l - o.props.targetHeight)
                    : (f.offsetY -= o.props.y + l - window.innerHeight + 10)),
                  o.setState(f, o._componentWillEnter);
              }),
          ...
          return (
            (o.componentDidMount = function () {
              y.ComponentDispatch.subscribe(
                m.ComponentActions.POPOUT_CLOSE,
                this.close
              ),
                document.addEventListener("click", this.close, !0),
                document.addEventListener("contextmenu", this.closeContext, !0),
                this.updateOffsets();
            }),
            ...
            (o.componentDidUpdate = function (t) {
              ...
              (this.props.text === e &&
                ...
                this.props.closeOnScroll === s) ||
                this.updateOffsets(),
                this.props.needsRerender &&
                  f.default.didRerender(this.props.popoutKey);
            }),
            (o.componentWillUnmount = function () {
              y.ComponentDispatch.unsubscribe(
                m.ComponentActions.POPOUT_CLOSE,
                this.close
              ),
                document.removeEventListener("click", this.close, !0),
            ...
            (o.render = function () {
              ...
              P.visibility ||
                (P.visibility = null == P.transform ? "hidden" : "visible");
              var S =
                (((t = {})[v.default.popoutInvert] = r && u),
                (t[v.default.noArrow] = !k),
                (t[v.default.noShadow] = !this.props.shadow || "none" === y),
                t);
              return (
                x && (S[x] = !0),
                O(
        ...
        return (
          ...
          (e.prototype.render = function () {
            ...
            return O(
              ...
              void 0,
              O(h.default, { zIndexBoost: null != a ? a : 0, isVisible: n }),
              o.map(function (t) {
                var e = t.key,
                  o = (function (t, e) {
                    if (null == t) return {};
                    ...
                    for (n = 0; n < i.length; n++)
                      (o = i[n]), e.indexOf(o) >= 0 || (r[o] = t[o]);
                    return r;
                  })(t, ["key"]);
                return r.createElement(
                  M,
                  C({ popoutKey: String(e) }, o, { key: e + "-popout" })
                );
              })
            );
          }),
      ...
      N.displayName = "Popouts";
      var Y = l.default.connectStores([d.default], function () {
        return { popouts: d.default.getPopouts() };
      })(N);
      e.default = Y;
    },
    8307: function (t, e, o) {
      ...
      var a = {
        ...
        close: function (t) {
          r.default.dirtyDispatch({ type: i.ActionTypes.POPOUT_CLOSE, key: t });
        },
        closeAll: function () {
          r.default.dirtyDispatch({ type: i.ActionTypes.POPOUT_CLOSE_ALL });
        },
        rerender: function (t) {
          r.default.dirtyDispatch({
